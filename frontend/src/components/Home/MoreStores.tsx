            ...
            <Grid container spacing={4}>
                <Grid item xs={12}>
                    <Box className="flex justify-between items-center">
                        ...
                        <div>
                            <Link className="flex gap-3 items-center text-[#00670c]" href={"#"}>View All <ArrowForwardIos/></Link>
                        </div>
                    </Box>
                </Grid>
            </Grid>
            <Grid container spacing={3} className="mt-5">
                <Grid item xs={2}>
                    <Box className="flex flex-col justify-center items-center gap-3">
                        <img src="logo 1.png" className="w-[100px] h-[100px] rounded-full" alt="" />
                ...
                <Grid item xs={2}>
                    <Box className="flex flex-col justify-center items-center gap-3">
                        <img src="logo 2.png" className="w-[100px] h-[100px] rounded-full" alt="" />
                ...
                <Grid item xs={2}>
                    <Box className="flex flex-col justify-center items-center gap-3">
                        <img src="logo 3.png" className="w-[100px] h-[100px] rounded-full" alt="" />
                ...
                <Grid item xs={2}>
                    <Box className="flex flex-col justify-center items-center gap-3">
                        <img src="logo 4.png" className="w-[100px] h-[100px] rounded-full" alt="" />
                ...
                <Grid item xs={2}>
                    <Box className="flex flex-col justify-center items-center gap-3">
                        <img src="logo 5.png" className="w-[100px] h-[100px] rounded-full" alt="" />
